...
function load(pdbId) {
    pv.io.fetchPdb('http://www.rcsb.org/pdb/files/' + pdbId + '.pdb', function (molecule) {
        structure = molecule;
        cartoon();
...
var nxentry = _getURLParameter("nxentry") || 'NX_P01308';

$.getJSON("https://api.nextprot.org/entry/" + nxentry + "/identifier.json", function (data) {
